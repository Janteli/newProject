...
const Footer = () => {
  return (
    <div className="mt-16 ">
      ...
      <div className="bg-[url('https://cdn.prod.website-files.com/646f3c0d1e3793b7397635eb/64a562b9492999ffae211108_grain_less.png')] md:h-fit h-[400px] grid md:grid-cols-12 md:gap-20 grid-rows-4 relative md:mt-24 px-2 md:py-24">
        {/* Left Section */}
        <div className="md:col-span-6 md:pl-24 md:py-12 row-span-1 mt-6">
          <h1 className="leading-tight font-extrabold text-white text-left -mb-6">
        ...
        {/* Right Section */}
        <div className="md:col-span-6 md:grid md:grid-cols-12 md:gap-4 row-span-1  flex pt-8">
          {/* Inner Columns */}
          <div className="col-span-4 text-white p-4 rounded-md">
