...
const DemoCart = ({ selectedTime, selectedDate }) => {
  ...
  return (
    <div className="bg-white px-4 sm:px-6 lg:px-8">
      ...
      {!token ? (
            <div className="flex flex-col gap-4 items-center justify-center min-h-[calc(100vh-8rem)] cursor-pointer" onClick={()=>login()}  >
               <svg
          ...
          <div
            className="py-2 px-4 bg-blue-500 text-white rounded-md hover:bg-blue-600 transition  flex flex-col items-center justify-center gap-2"
          >
